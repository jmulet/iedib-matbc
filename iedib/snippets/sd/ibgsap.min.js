...
!function(){"use strict";function e(e,a){try{return JSON.parse(e)}catch(t){return console.error("[gsap-init] JSON inválido en escena:",a,"\n",t.message,"\n","JSON recibido:",e),null}}function a(e,a){return"true"===e.getAttribute(a)}function t(e,a){e.setAttribute("style",p.errorStyle),e.setAttribute("title","[gsap-init error] "+a)}function r(e){return e&&"string"==typeof e?e.replace(/\bgeq\b/g,">=").replace(/\bleq\b/g,"<=").replace(/\bgt\b/g,">").replace(/\blt\b/g,"<").replace(/\bplus\b/g,"+").replace(/\bminus\b/g,"-").replace(/\band\b/g,"&").replace(/\bor\b/g,"|").replace(/\blt(?=\d)/g,"<").replace(/\bgt(?=\d)/g,">").replace(/\bplus(?=\d)/g,"+").replace(/\bminus(?=\d)/g,"-"):e}function n(){var e="ibgsap-scroll-hint",a=document.getElementById(e);if(a)return a;var t=p.scrollBadge,r=document.createElement("div");r.id=e,r.setAttribute("aria-hidden","true");var n=document.documentElement.lang||"ca",o=n.split("-")[0].toLowerCase(),i=t.translations[o]||t.translations.ca;return r.textContent="↓ "+i,Object.assign(r.style,{position:"fixed",bottom:t.bottom,left:"50%",transform:"translateX(-50%)",background:t.background,color:t.color,padding:t.padding,borderRadius:t.borderRadius,fontSize:t.fontSize,letterSpacing:t.letterSpacing,pointerEvents:"none",zIndex:t.zIndex,opacity:"0",transition:t.transition}),document.body.appendChild(r),r}function o(e,a,t){var n=gsap.timeline();return e.forEach(function(e,i){if(e.subtimeline){if(!Array.isArray(e.subtimeline))return void console.warn("[gsap-init] step["+i+"].subtimeline no es un array",e);var s=o(e.subtimeline,a,t),l=r(void 0!==e.position?e.position:p.defaults.position);return t&&console.log('[gsap-init] subtimeline en posición "'+l+'"'),void n.add(s,l)}if(!e.target)return void console.warn("[gsap-init] step["+i+'] no tiene "target"',e);var d;if(d=Array.isArray(e.target)?e.target.map(function(e){return a.querySelector(r(e))}).filter(Boolean):a.querySelector(r(e.target)),!d||Array.isArray(d)&&0===d.length)return void console.warn('[gsap-init] target "'+e.target+'" no encontrado en',a);var c=e.from||{},g={},u=e.to||{};for(var v in u)g[v]=u[v];var l=r(void 0!==e.position?e.position:p.defaults.position);g.duration=void 0!==e.duration?e.duration:p.defaults.duration,g.ease=void 0!==e.ease?e.ease:p.defaults.ease,void 0!==e.stagger&&(g.stagger=e.stagger),void 0!==e.repeat&&(g.repeat=e.repeat),void 0!==e.yoyo&&(g.yoyo=e.yoyo),t&&console.log("[gsap-init] step["+i+'] target="'+e.target+'"',"from:",c,"to:",g,"position:",l),Object.keys(c).length>0?n.fromTo(d,c,g,l):n.to(d,g,l)}),n}function i(n){var i=a(n,p.debugAttr)||null!==n.closest("[data-gsap-debug='true']"),s=n.querySelector("[data-gsap-timeline]");s?"TEMPLATE"!==s.tagName&&(s.style.display="none"):i&&console.log("[gsap-init] escena sin timeline:",n);var l=s?"TEMPLATE"===s.tagName?s.innerHTML:s.textContent:"[]",d=l.replace(/<br\s*\/?>/gi," ").replace(/[\r\n]+/g," ").trim(),c=e(d,n);if(null===c)return void t(n,"JSON inválido en <template data-gsap-timeline>");if(!Array.isArray(c))return t(n,"El JSON debe ser un array [ ... ]"),void console.error("[gsap-init] El JSON debe ser un array. Recibido:",c);var g=o(c,n,i),u=n.getAttribute("data-gsap-start"),v=n.getAttribute("data-gsap-end"),f={animation:g,trigger:n,start:r(null!==u?u:p.defaults.start),end:r(null!==v?v:p.defaults.end),scrub:a(n,"data-gsap-scrub")||p.defaults.scrub,pin:a(n,"data-gsap-pin")||p.defaults.pin,markers:a(n,"data-gsap-markers")||i,anticipatePin:1},b=n.getAttribute("data-gsap-scrub");b&&"true"!==b&&"false"!==b&&(f.scrub=parseFloat(b)),i&&console.log("[gsap-init] ScrollTrigger config:",f),ScrollTrigger.create(f)}function s(e,a){var t=e.querySelectorAll("[data-gsap-observe-x], [data-gsap-observe-y], [data-gsap-observe-rotation], [data-gsap-observe-opacity], [data-gsap-observe-scale]");if(t.length){var r=[];if(t.forEach(function(e){var a=e.dataset,t={},n=!1;for(var o in a)if(0===o.indexOf("gsapObserve")&&"gsapObserve"!==o){var i=o.replace("gsapObserve","");i=i.charAt(0).toLowerCase()+i.slice(1),t[i]=parseFloat(a[o]),n=!0}if(n){var s={};for(var l in t)s[l]=gsap.quickTo(e,l,{duration:.8,ease:"power2"});r.push({el:e,props:t,qTo:s})}}),r.length){a&&console.log("[gsap-init] Inicialitzant Observer per a",e);var n=e.dataset.gsapObserve||"pointer";"true"===n&&(n="pointer"),Observer.create({target:e,type:n,onMove:function(a){var t=e.getBoundingClientRect(),n=(a.x-t.left)/t.width*2-1,o=(a.y-t.top)/t.height*2-1;r.forEach(function(e){for(var a in e.qTo){var t=e.props[a],r=0;r="x"===a||"rotation"===a||"skewX"===a?n*t:"y"===a||"skewY"===a?o*t:"opacity"===a?1+Math.max(Math.abs(n),Math.abs(o))*t:Math.max(Math.abs(n),Math.abs(o))*t,e.qTo[a](r)}})}})}}}function l(e){function o(){k++,k+F===v&&(s(),c())}function i(e){F++,o()}function s(){var a=window.devicePixelRatio||1,t=e.clientWidth,r=Math.round(t/E);x.style.width=t+"px",x.style.height=r+"px",x.width=Math.round(t*a),x.height=Math.round(r*a),O.scale(a,a),l(T)}function l(e){var a=window.devicePixelRatio||1,t=x.width/a,r=x.height/a;if(O.clearRect(0,0,t,r),f){if(!q||!q.complete)return;var n=q.width/b,o=Math.ceil(v/b),i=q.height/o;if(!y||2>v){var s=Math.max(0,Math.min(v-1,Math.round(e))),l=Math.floor(s/b),c=s%b;return void O.drawImage(q,c*n,l*i,n,i,0,0,t,r)}var g=Math.max(0,Math.min(v-1,e)),p=Math.floor(g),u=Math.min(p+1,v-1),m=d(g-p,S/v);if(0===m||p===u){var h=Math.floor(p/b),w=p%b;O.drawImage(q,w*n,h*i,n,i,0,0,t,r)}else{var A=Math.floor(p/b),M=p%b,C=Math.floor(u/b),E=u%b;O.globalAlpha=1,O.drawImage(q,M*n,A*i,n,i,0,0,t,r),O.globalAlpha=m,O.drawImage(q,E*n,C*i,n,i,0,0,t,r)}return void(O.globalAlpha=1)}if(!y||2>v){var s=Math.max(0,Math.min(v-1,Math.round(e)));return void(I[s]&&I[s].complete&&O.drawImage(I[s],0,0,t,r))}var g=Math.max(0,Math.min(v-1,e)),p=Math.floor(g),u=Math.min(p+1,v-1),m=d(g-p,S/v);0===m||p===u?(O.globalAlpha=1,I[p]&&I[p].complete&&O.drawImage(I[p],0,0,t,r)):(I[p]&&I[p].complete&&(O.globalAlpha=1,O.drawImage(I[p],0,0,t,r)),I[u]&&I[u].complete&&(O.globalAlpha=m,O.drawImage(I[u],0,0,t,r))),O.globalAlpha=1}function c(){function a(){r.style.opacity="1"}function t(){r.style.opacity="0"}var r=n(),o={frame:0};gsap.to(o,{frame:v-1,ease:"none",scrollTrigger:{trigger:e,start:w,end:A,scrub:h,markers:M,pin:!0,anticipatePin:1,onEnter:a,onLeave:t,onEnterBack:a,onLeaveBack:t},onUpdate:function(){T=o.frame,l(o.frame)}})}var g=e.dataset,u=g.gsapCanvasSrc,v=parseInt(g.gsapCanvasFrames),f="true"===(g.gsapCanvasSprite||"false"),b=parseInt(g.gsapCanvasCols||"1"),m=parseInt(void 0!==g.gsapCanvasPad?g.gsapCanvasPad:p.canvas.pad),h=parseFloat(void 0!==g.gsapCanvasScrub?g.gsapCanvasScrub:p.canvas.scrub),y="true"===(void 0!==g.gsapCanvasFade?g.gsapCanvasFade:String(p.canvas.fade)),S=parseInt(void 0!==g.gsapCanvasFadeFrames?g.gsapCanvasFadeFrames:p.canvas.fadeFrames),w=r(void 0!==g.gsapCanvasStart?g.gsapCanvasStart:p.canvas.start),A=r(void 0!==g.gsapCanvasEnd?g.gsapCanvasEnd:p.canvas.end),M="true"===(g.gsapCanvasMarkers||"false");a(e,p.debugAttr)||null!==e.closest("[data-gsap-debug='true']");if(!u)return void t(e,"data-gsap-canvas-src es requerido");if(!v||isNaN(v))return void t(e,"data-gsap-canvas-frames es requerido");var C=void 0!==g.gsapCanvasRatio?g.gsapCanvasRatio:p.canvas.ratio,E=Function("return "+C)();e.style.display="flex",e.style.alignItems="center",e.style.justifyContent="center",e.style.overflow="hidden";var x=document.createElement("canvas");x.style.display="block",e.appendChild(x);var O=x.getContext("2d"),T=0,q=null,I=f?null:new Array(v),k=0,F=0;if(f)q=new Image,q.src=u,q.onload=function(){k=v,s(),c()},q.onerror=function(){t(e,"Error cargando sprite: "+u)};else for(var z=0;v>z;z++)!function(e){var a=new Image,t=String(e);if(m>0)for(;t.length<m;)t="0"+t;a.src=u.replace("{i}",t),a.onload=o,a.onerror=function(){i(e)},I[e]=a}(z);window.addEventListener("ibgsap:layout",function(){s(),ScrollTrigger.refresh()})}function d(e,a){return 0>=a?e>0?1:0:Math.min(1,e/a)}function c(e){var a=e.querySelectorAll("[data-gsap-depth]");if(0!==a.length){var t=r(void 0!==e.dataset.gsapStart?e.dataset.gsapStart:"top bottom"),n=r(void 0!==e.dataset.gsapEnd?e.dataset.gsapEnd:"bottom top"),o=e.dataset.gsapScrub;o=void 0===o||"true"===o?!0:"false"===o?!1:parseFloat(o)||!0;var i=gsap.timeline({scrollTrigger:{trigger:e,start:t,end:n,scrub:o}});a.forEach(function(e){var a=parseFloat(e.getAttribute("data-gsap-depth"))||0;i.fromTo(e,{y:0},{y:-300*a,ease:"none"},0)})}}function g(){if(!window.matchMedia("(prefers-reduced-motion: reduce)").matches&&!window.matchMedia("print").matches&&"undefined"!=typeof gsap&&"undefined"!=typeof ScrollTrigger){"undefined"==typeof Observer&&"undefined"!=typeof ScrollTrigger.Observer&&(window.Observer=ScrollTrigger.Observer),gsap.registerPlugin(ScrollTrigger,Observer);var e=function(){ScrollTrigger.refresh(),window.dispatchEvent(new CustomEvent("ibgsap:layout"))};window.addEventListener("resize",e);var a=document.querySelector('div[role="main"]')||document.body;window.ResizeObserver&&new ResizeObserver(e).observe(a);for(var t=document.querySelectorAll("[data-gsap-parallax]"),r=0;r<t.length;r++)c(t[r]);for(var n=document.querySelectorAll("[data-gsap-scene]"),o=0;o<n.length;o++){var d=n[o];d.style.userSelect="none",d.style.webkitUserSelect="none";for(var g=d.querySelectorAll(".position-absolute, .position-relative"),p=0;p<g.length;p++)g[p]!==d&&(g[p].style.pointerEvents="none");for(var u=d.querySelectorAll("img, a, button, .interactive, [class*='-bg'], [class*='-stat'], [class*='-title'], [class*='-label'], [class*='-desc']"),v=0;v<u.length;v++)u[v].style.pointerEvents="auto";i(d)}for(var f=document.querySelectorAll("[data-gsap-canvas]"),b=0;b<f.length;b++)l(f[b]);for(var m=document.querySelectorAll("[data-gsap-observe]"),h=0;h<m.length;h++)s(m[h],!1)}}var p={defaults:{start:"top 75%",end:"bottom 25%",scrub:!0,pin:!1,markers:!1,duration:.5,ease:"power2.out",position:">"},canvas:{ratio:"16/9",scrub:.5,fade:!1,fadeFrames:3,pad:0,start:"top top",end:"+=300%",markers:!1},scrollBadge:{text:"Scroll per continuar",translations:{ca:"Scroll per continuar",es:"Haz scroll para continuar",en:"Scroll to continue",fr:"Scrollez pour continuer",de:"Scrollen zum Fortfahren"},bottom:"5rem",background:"rgba(0,0,0,0.65)",color:"#fff",padding:"0.45em 1.1em",borderRadius:"2em",fontSize:"0.85rem",letterSpacing:"0.03em",transition:"opacity 0.35s ease",zIndex:"9999"},debugAttr:"data-gsap-debug",errorStyle:"outline: 3px solid red; outline-offset: 4px;"};"loading"===document.readyState?document.addEventListener("DOMContentLoaded",g):g()}();